...
import bike.drive.com.handler.ReportHandler;
...
public class ApplicationTest {
    ...
    void test_commandExecution_forProperCommand_PLACE() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException{
        Method pm = Application.class.getDeclaredMethod("commandExecution", BikeActionHandler.class, ReportHandler.class, String.class);
        pm.setAccessible(true);
        BikeActionHandler mockHandler = mock(BikeActionHandler.class);
        ReportHandler mockRepHandler = mock(ReportHandler.class);
        pm.invoke(testApp, mockHandler, mockRepHandler, "PLACE 2,3,WEST");
    ...
    void test_commandExecution_forWrongCommand_PLACE() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException{
        ...
        BikeActionHandler mockHandler = mock(BikeActionHandler.class);
        ReportHandler mockRepHandler = mock(ReportHandler.class);
        pm.invoke(testApp, mockHandler, mockRepHandler, "PLACE 2,3,");
